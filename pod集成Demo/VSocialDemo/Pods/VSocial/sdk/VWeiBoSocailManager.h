...
@interface VWeiBoSocailManager : NSObject
...
/**
 *  判断是否安装微博(如果不起作用，可用下面的方法替代)
 *  BOOL isWxInstalled = [[UIApplication sharedApplication] canOpenURL:[NSURL URLWithString:@"sinaweibo://"]];
 */
